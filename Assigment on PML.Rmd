...
The purpose of this assignment is to test the understanding the applicability of various machine learning algorithms.
...
```
#### Conclusion
Based on the perctenage of accuracy, we have identified that random forest model is best in this scenario and hence applied on the testdata to predict.
## R Markdown
